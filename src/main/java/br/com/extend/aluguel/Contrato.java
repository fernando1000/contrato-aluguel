...
public class Contrato {
	...
	public void gera() throws FileNotFoundException, DocumentException {
		...
		p2.add(new Chunk("Uma casa com "+this.comodosDaCasa+", situado na "+this.logradouro+", Parque Boa Esperança, 06653-590, Itapevi SP.", fontConteudo));
		p2.add("\n\n");
		...
		p6.add(new Chunk("O aluguel mensal deverá ser pago todo dia "+this.diaPagamento+" e seu valor é de "+this.valorAluguel+" mensais reajustados anualmente em conformidade com a variação IGP-M. Sendo que no primeiro mês de aluguel o locatário deverá efetuar um depósito de um mês de aluguel antecipado.", fontConteudo));
		...
		if(this.logradouroAgua != null) {
			p8.add("\n");
			p8.add(new Chunk("•	Observação: o endereço da água fica situado na "+this.logradouroAgua+", com a instalação numero "+this.numeroInstalacaoAgua+".", fontConteudo));
		}
		if(this.logradouroLuz != null) {
			p8.add("\n");
			p8.add(new Chunk("•	Observação: o endereço da luz  fica situado na "+this.logradouroLuz+", com a instalação numero "+this.numeroInstalacaoLuz+".", fontConteudo));			
		}
		p8.add("\n\n");
